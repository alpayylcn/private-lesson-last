...
<div class="mb-3 col-md-4">
    ...
    <select name="city" id="Iller" class="select2 form-select" required>
      @if (!empty($data['userDetailData']->district))
       <option value="" selected>{{$data['userDetailData']->district}}</option> 
      @endif
...
<div class="mb-3 col-md-4">
    <label class="form-label" for="county">İlçe</label>
    <select name="county" id="Ilceler" class="select2 form-select" disabled="disabled" required>
      @if (!empty($data['userDetailData']->district))
       <option value="">{{$data['userDetailData']->district}}</option> 
      @endif
