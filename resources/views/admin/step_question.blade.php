          ...
          <div class="col-md-8">
            <div class="card mb-4">
              ...
              <div class="card-body mb-3">
                ...
                <table class="col-12">
                  <th id="th1">Öğrenci Filtre Ekranı</th>
                  <th id="th2">Öğretmenin Gördüğü</th>
                   {{-- js den gelen içerik  --}}
                  <tr id="step-option-titles" > </tr>
                    {{-- js den gelen içerik  --}}
              ...
              <h5 class="card-header">YENİ BAŞLIK EKLEME </small></h5>
                <div class="card-body mb-3">
                  ...
                  <div id="defaultFormControlHelp" class="form-text mb-1">
                   ...
                   <form method="POST" action="{{route('admin.filterOptionsAdd')}}" enctype="multipart/form-data">
                    @csrf 
                    <input type="hidden" name="user_id" value="{{$userId}}">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        `;
                            ...
                            $('#step-question-id').append('<input type="hidden" name="question_id"value="'+stepOptionTitle.question_id+'">');
